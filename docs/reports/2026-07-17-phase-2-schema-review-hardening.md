# Report: Phase 2 schema review exposed six cross-layer invariants

| | |
| --- | --- |
| **Date** | 2026-07-17 |
| **Area** | database / RLS / Supabase Storage / testing |
| **Cost** | ~6h elapsed from the first schema commit to the final hardening pass; 3 review rounds, 6 findings, and 1 formatting detour |
...
| **Commits / PRs** | `718f2d6`, `9d7ea45`, `c74a3c6`, `6cdb9e7`, `c835fd8`, `d0e4450`, `8660391`, `3771a49` |
| **Issues** | #72 (run pgTAP in CI) |
| **Tags** | supabase, postgres, rls, foreign-key, concurrency, advisory-lock, storage, coordinated-delete, pgtap |
...
boundary. The pgTAP suite grew from 38 to 44 tests.
...
The review found six ways valid-looking local rules could still violate the
...
final hardening      44 pgTAP tests after a local reset
```
